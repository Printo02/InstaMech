...
if($action=='reject')
{
	...
	echo $obj->alert("update successfully","../carriage_list.php?type=rejected");*/
	if($res['status']='true')
	{
		echo $obj->alert("Successfully Rejected","../carriage_list.php?type=rejected");

	}
	else
	{
		echo $obj->alert("Something went wrong","../carriage_list.php?type=rejected");
...
elseif ($action=='delete') 
{
	...
	if($res['status']='true')
	{
		echo $obj->alert("Successfully Deleted","../carriage_list.php?type=rejected");
