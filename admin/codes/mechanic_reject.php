...
if($action=='reject')
{
	...
	echo $obj->alert("update successfully","../mechanic_list.php?type=reject");*/
	if($res['status']='true')
	{
		echo $obj->alert("Successfully Updated","../mechanic_list.php?type=reject");

	}
	else
	{
		echo $obj->alert("Something went wrong","../mechanic_list.php?type=reject");
...
elseif ($action=='delete') 
{
	...
	//echo $obj->alert("Deleted successfully","../mechanic_list.php?type=reject");
	if($res['status']='true')
	{
		echo $obj->alert("Successfully Deleted","../mechanic_list.php?type=reject");
