...
echo $obj->alert("update successfully","../carriage_list.php?type=approved");*/
if($res['status']='true')
{
	echo $obj->alert("Successfully Updated","../carriage_list.php?type=approved");

}
else
{
	echo $obj->alert("Something went wrong","../carriage_list.php?type=approved");
